...
# The CMD ["python3.13",  "-m",  "streamlit", "run" "--server.port", "8000", "src/Forecast.py"]
...
# I.e. docker run <container-id> /weather/healthcheck.sh
...
(python3.13 -m streamlit run --server.port 8000 src/Forecast.py) &
spid=$!
sleep 5
